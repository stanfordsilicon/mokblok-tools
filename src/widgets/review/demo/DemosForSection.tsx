...
const demoIDsBySection: Record<DataSection, DemoID[]> = {
  ...
  [DataSection.LanguageNames]: [DemoID.LanguageNamesSelector],
  [DataSection.Maths]: [],
  [DataSection.Months]: [DemoID.MonthsGrid, DemoID.MonthsTemp, DemoID.MonthsSelector],
  [DataSection.Plurals]: [],
